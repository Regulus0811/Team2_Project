...
function viewList(idx){ // 리스트 출력
    for(let i = 0; i < arr[idx - 1]; i++){
        ...
        list_link.classList.add('card','list_link', 'draggable');
        list_link.draggable;
        ...
        list_item.append(list_item_img, list_item_body);

        list_link.append(list_item);
        ...
        $plansList.appendChild(list_link);
