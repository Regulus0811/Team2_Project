  ...
  async getHtml() {
    ...
    <div id="inputModal" class="modal">
      <div class="modal-content">
        ...
        <label for="newImageFile">이미지 파일을 업로드하세요:</label>
        <input type="file" id="newImageFile" accept="image/*" />
        <label for="newName">새 이름을 입력하세요:</label>
        <input type="text" id="newName" name="newName" />
        <label for="newDescription">새 설명을 입력하세요:</label>
        <textarea id="newDescription" name="newDescription"></textarea>
        <button id="submitData">제출</button>
      </div>
    </div>
